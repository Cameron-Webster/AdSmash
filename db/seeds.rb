...
z = User.create(name: Faker::Name.first_name, last_name: Faker::Name.last_name, company: "faker company", password: "123456", email: Faker::Internet.email)
  ...
  3.times do
    v = Project.create(name: Faker::Beer.name, campaign_start: "2017-06-07", status: Project::STATUSES.sample , brand: Project::BRANDS.sample , deadline: "2017-05-06", brief: Faker::Lorem.paragraph(2))
